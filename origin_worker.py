...
class Worker:
    def __init__(self, mete_agent_id, local_network, local_baseline, global_step,
                 device='cuda', seed=None, env_params=None):
        ...
        self.env = TaskEnv(*env_params, EnvParams.TRAIT_DIM, seed=seed)
...
if __name__ == '__main__':
    ...
    for i in range(100):
        worker = Worker(1, localNetwork, localNetwork, 0, device=device, seed=i)
        worker.work(i)
        print(i)
